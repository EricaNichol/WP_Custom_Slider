...
<?php
if( !class_exists('Feature_Slider') ) {
	class Feature_Slider {
		const FEATURE_SLIDER = 'feature_slider';

		public function __construct() {
			add_action('init','register_feature_slider');
...
function register_feature_slider() {
	$labels = array(
		'name' => _x('Feature Slider', 'post type general name'),
		'singular_name' => _x('Feature Slider', 'post type singular name'),
		'add_new' => _x('Add New', 'Feature Slider'),
		'add_new_item' => __('Add New Feature Slider'),
		'edit_item' => __('Edit Feature Slider'),
		'new_item' => __('New Feature Slider'),
		'all_items' => __('All Feature Slider'),
	...
	register_post_type( Feature_Slider::FEATURE_SLIDER, $args );
